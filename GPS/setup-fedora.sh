#!/bin/bash
# SignalSight GPS System - Automated Setup Script (Fedora)
...
echo "=========================================="
echo "SignalSight GPS System Setup (Fedora)"
echo "=========================================="
echo ""
...
sudo dnf install -y python3-pip python3-devel gcc gcc-c++ make sqlite
...
if [ -f "99-gps.rules" ]; then
    ...
    echo "Warning: 99-gps.rules not found. Skipping GPS symlink setup."
fi
